	...
	$(document).ready(function(){
		...
		$("#btn_tambah_transaksi").click(function(){
			...
			$.ajax({
				...
				data: {id_anggota:id_anggota, id_buku:id_buku, id_petugas:id_petugas, tgl_pinjam:tgl_pinjam, due_date:due_date},
				type: 'POST',
		...
		$(".ubah").click(function(){
			var id = $(this).attr('id');
			$("#isiModalUpdate").load("update_transaksi_pinjam.php?id="+id);
		});
	});
</script>
...
<div class="row bg-title">
    ...
    <h4 class="page-title">Transaksi / <a>Pinjam</a></h4> </div>
</div>
